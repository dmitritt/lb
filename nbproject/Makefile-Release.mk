...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/loadbalancer: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/loadbalancer ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${TESTDIR}/src/tests/newsimpletest.o: src/tests/newsimpletest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/newsimpletest.o src/tests/newsimpletest.cpp
...
${OBJECTDIR}/src/client_nomain.o: ${OBJECTDIR}/src/client.o src/client.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/client_nomain.o src/client.cpp;\
	else  \
...
${OBJECTDIR}/src/server_nomain.o: ${OBJECTDIR}/src/server.o src/server.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/server_nomain.o src/server.cpp;\
	else  \
